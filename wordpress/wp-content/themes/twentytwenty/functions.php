...
function twentytwenty_register_styles() {
	...
	wp_register_style( 'gulp-styles', get_template_directory_uri() . '/assets/css/gulp-style.css' );
	wp_enqueue_style('gulp-styles');
...
// add_shortcode('my_select', 'shortcode_select');

// wpcf7_add_form_tag('my_select', 'shortcode_select');
...
// 	$options = '<p>
// 		<span class="wpcf7-form-control-wrap menu-59">
// 			<select class="wpcf7-form-control wpcf7-select" name="menu-59" >' ;

// 	foreach ($wpdb->get_results("SELECT * FROM wp.pn_slider ;") as $row) {
// 		$options .= '<option>' .$row->id.'. '.$row->link .'</option>';
// 	}
...
// 	$list_types['emails'] = 'Listo_Emails';
// 	return $list_types;
// }


// class Listo_Emails implements Listo {
